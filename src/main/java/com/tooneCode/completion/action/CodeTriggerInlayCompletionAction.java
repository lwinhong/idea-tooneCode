...
//            CosyInlayManager.getInstance().disposeInlays(editor, InlayDisposeEventEnum.TRIGGER_ACTION);
//            CosyInlayManager.getInstance().editorChanged(CompletionTriggerConfig.defaultConfig(InlayTriggerEventEnum.MANUAL_TRIGGER), editor, CompletionTriggerModeEnum.MANUAL);
