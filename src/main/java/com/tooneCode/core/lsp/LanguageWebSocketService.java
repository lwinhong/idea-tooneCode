...
public class LanguageWebSocketService {
    ...
    public void connect() throws DeploymentException, IOException {
        ...
        this.server = new LanguageServerImpl(this.client);
    }
    ...
    public List<CompletionItem> completion(CompletionParams params, long timeout) {
        ...
        try {
            ...
            log.info("code trigger completion:" + var10001 + " local:" + params.getUseLocalModel() + " remote:" + params.getUseRemoteModel());
...
//        }
    ...
    public List<ChatSession> listAllSessions(ListChatHistoryParams listChatHistoryParams, long timeout) {
        ...
        try {
            ...
            log.warn("code chat list all sessions request timeout");
        } catch (Exception var7) {
            Exception e = var7;
            log.warn("code chat list all sessions error " + e.getMessage(), e);
        }
    ...
    public ChatSession getSessionById(GetChatSessionParams getChatSessionParams, long timeout) {
        ...
        try {
            ...
            log.warn("code chat get session by id request timeout");
        } catch (Exception var7) {
            Exception e = var7;
            log.warn("code chat get session by id error " + e.getMessage(), e);
        }
    ...
    public boolean deleteChatById(DelChatRecordParams delChatRecordParams) {
        ...
        try {
            ...
            Exception e = var3;
            log.warn("code chat delete chat by id error " + e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean deleteSessionById(DelChatSessionParams delChatSessionParams) {
        ...
        try {
            ...
            Exception e = var3;
            log.warn("code chat delete session by id error " + e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean clearAllSessions() {
        try {
            ...
            Exception e = var2;
            log.warn("code chat clear all sessions error " + e.getMessage(), e);
            return false;
        }
    }
